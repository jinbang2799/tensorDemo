...
# % % time
history = model.fit(x_train, y_train, batch_size=512, epochs=100, validation_split=0.1)
model.save('cifar-10_1.h5')
...
# % % time
history2 = model.fit(x_train, y_train, batch_size=512, epochs=100, validation_split=0.1)
